...
class SlicSITK(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "SlicSITK"  # TODO: make this more human readable by adding spaces
...
See more information in <a href="https://github.com/organization/projectname#SlicSITK">module documentation</a>.
"""
...
class SlicSITKWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def setup(self):
    ...
    uiWidget = slicer.util.loadUI(self.resourcePath('UI/SlicSITK.ui'))
...
class SlicSITKLogic(ScriptedLoadableModuleLogic):
...
class SlicSITKTest(ScriptedLoadableModuleTest):
  """
  ...
  def test_SlicSITK1(self):
    ...
    #test with Slik4.tif file

    inputVolume = slicer.util.loadVolume("C:/Users/Anna/Documents/StageM2/MySlicerExtensions/TestSlic/SlicTest/Resources/UI/Slik4.tif")
